...
class SystemConfig:
    ...
    def __init__(self):
        ...
        self.LOW_MEMORY_MODE = os.getenv("LOW_MEMORY_MODE", "true").lower() in ("1", "true", "yes") or bool(os.getenv("RENDER"))
        ...
        self.PYABSA_MODEL = "aste_training_set_custom"
        ...
        self.RAG_CORPUS_DIRS = [
            ...
            self.DATASET_ROOT / "tat_cards",
        ]
        self.RAG_EMBEDDING_MODEL = "all-MiniLM-L6-v2"
        self.RAG_TOP_K = 5
