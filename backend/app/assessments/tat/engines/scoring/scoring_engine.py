...
class TATScoringEngine:
    ...
    def score_story(self, story_text: str, events: list = None) -> Dict[str, Any]:
        ...
        ego_strength = (resolution_score + agency) * 50
        ...
        reality_testing = max(20, reality_testing)

        from app.utils.production_utils import compute_affective_integration
        words = story_text.split() if story_text else []
        affective_integration_raw = compute_affective_integration(events, words)
        affective_integration = affective_integration_raw * 10.0
        ...
        dimension_scores = {
            ...
            'affective_integration': min(100, max(0, affective_integration)),
