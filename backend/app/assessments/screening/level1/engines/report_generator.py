...
def generate_report(
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        h2 = ParagraphStyle(
            ...
            textColor=HexColor('#ce1126'), spaceBefore=18, spaceAfter=8,
        )
        h3 = ParagraphStyle(
            'H3', fontName='Helvetica-Bold', fontSize=8,
            textColor=HexColor('#ce1126'), spaceBefore=10, spaceAfter=6,
        )
        body = ParagraphStyle(
        ...
        coretat_logo_path = PROJECT_ROOT / "frontend" / "public" / "coretat-report-logo.png"

        story.append(HRFlowable(width="100%", thickness=12, color=HexColor('#ce1126'), spaceBefore=-20, spaceAfter=20))
        ...
        if clinic_info:
            ...
            if c_name:
                left_content.append(Paragraph(c_name.upper(), ParagraphStyle('CName', fontName='Helvetica-Bold', fontSize=9, textColor=HexColor('#ce1126'), alignment=0, spaceAfter=2)))
        ...
        story.append(HRFlowable(width="100%", thickness=1, color=HexColor('#ce1126'), spaceBefore=0, spaceAfter=20))
        ...
        story.append(Paragraph(
            f"Report generated by CoreTAT Psychological Analysis System on {completed_at.strftime('%d-%m-%Y, %I:%M %p')}", small
        ))
