...
class TestPricing(Base):
    ...
    test_type = Column(String, nullable=False, unique=True)          # e.g., "TAT Full (20 cards)"
    individual_price_paise = Column(Integer, nullable=False)          # price for individual_psychologist
    clinic_price_paise = Column(Integer, nullable=False)              # price for clinic accounts
    org_price_paise = Column(Integer, nullable=False, default=2000)   # price for organization accounts
