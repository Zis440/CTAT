...
export function ClinicStaffSidebar() {
  ...
  const isActive = (to: string) => {
    ...
    if (to === "/clinic-staff/dashboard") return currentPath === "/clinic-staff/dashboard";
  ...
  const logoLink = "/clinic-staff/dashboard";
        ...
        {CLINIC_STAFF_NAV.map((group, idx) => {
          ...
          return (
            <div key={idx}>
              ...
              {idx < CLINIC_STAFF_NAV.length - 1 && group.label && (
