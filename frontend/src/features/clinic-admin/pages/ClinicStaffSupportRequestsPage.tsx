...
export function ClinicStaffSupportRequestsPage() {
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          >
            ...
            <p className="text-text/60 text-sm">
              Review and reply to support requests submitted by your {isOrg ? "organization" : "clinic"} staff.
            </p>
          </motion.div>
          {!isSelectionMode && (
            <Button
                      ...
                      <div className="flex flex-col items-center justify-center space-y-3">
                        ...
                        <p className="text-sm text-text/50 max-w-xs mx-auto">
                          {searchQuery || statusFilter !== "all"
                            ...
                            : `Your ${isOrg ? "organization" : "clinic"} staff haven't submitted any support requests.`}
                        </p>
                      </div>
                    </TableCell>
                  </TableRow>
