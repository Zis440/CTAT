...
export function ClinicOrgProfilePage() {
    ...
    <div className="space-y-6 w-full max-w-6xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      >
        <h1 className="text-3xl font-extrabold tracking-tight flex items-center gap-2">
          ...
          {isOrg ? "Organization" : "Clinic"} Profile
        </h1>
        <p className="text-muted-foreground mt-1 text-lg">Personalize your {isOrg ? "organization" : "clinic"}'s brand identity and public information.</p>
      </motion.div>
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                <Label className="text-sm font-semibold flex items-center gap-2 text-foreground/80">
                  <Building className="h-4 w-4 text-primary" /> {isOrg ? "Organization" : "Clinic"} Name
                </Label>
                <Input
                  value={clinicName}
