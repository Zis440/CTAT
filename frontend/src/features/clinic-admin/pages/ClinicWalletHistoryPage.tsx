...
export function ClinicWalletHistoryPage() {
  ...
  const pageTitle = `Wallet Transactions | ${roleSuffix}`;
                  ...
                  <PopoverContent align="end" className="w-80 p-4">
                    <div className="grid gap-4">
                      <div className="flex justify-between items-start">
                        ...
                        <Button variant="ghost" size="sm" onClick={clearFilters} className="h-8 px-2 text-muted-foreground hover:text-foreground -mt-1 -mr-1">
            ...
            <Table className="max-md:block">
              <TableHeader className="bg-primary/5 max-md:hidden">
                <TableRow className="hover:bg-transparent">
                  ...
                  <TableHead className="font-semibold">{isOrg ? "Candidate" : "Patient"}</TableHead>
                ...
                {isLoading ? (
                  Array.from({ length: 5 }).map((_, i) => (
                    <TableRow key={i} className="max-md:block max-md:p-4 max-md:border-b">
                      ...
                      <TableCell className="max-md:flex max-md:justify-between max-md:p-1 max-md:border-none">
                        <span className="md:hidden font-semibold text-muted-foreground">{isOrg ? "Candidate:" : "Patient:"}</span>
                        <Skeleton className="h-4 w-32" />
                      </TableCell>
                      <TableCell className="max-md:flex max-md:justify-between max-md:p-1 max-md:border-none">
                  ...
                  <TableRow className="max-md:block">
                    <TableCell colSpan={isSelectionMode ? 10 : 9} className="h-32 text-center max-md:block max-md:py-8">
                  ...
                  transactions.map((tx) => {
                    const { purpose, candidate: patientName, performedBy, testName } = parseTransactionDescription(tx.description);
