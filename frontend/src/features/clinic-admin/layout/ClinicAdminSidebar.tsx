...
import { CLINIC_ADMIN_NAV } from "./sidebarConfig";
...
export function ClinicAdminSidebar() {
  ...
  const isActive = (to: string) => {
    ...
    if (to === "/clinic/dashboard") return currentPath === "/clinic/dashboard";
  ...
  const logoLink = "/clinic/dashboard";
  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-border/50">
      ...
      <SidebarContent className="py-3 gap-1">
        ...
        {CLINIC_ADMIN_NAV.map((group, idx) => {
          ...
          return (
            <div key={idx}>
              ...
              {idx < CLINIC_ADMIN_NAV.length - 1 && group.label && (
