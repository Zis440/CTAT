...
import { ClipboardPlus, Filter, RotateCcw, Search, FileText, Trash2, X, History, Check, ShieldCheck, ScrollText, User } from "lucide-react";
...
export function SessionHistoryPage() {
  ...
  const canStartSession = !["clinic_admin", "org_admin"].includes(user?.role || "") && (!isStaff || !!user?.module_permissions?.assessments);
              ...
              <Table className="max-md:block">
                <TableHeader className="max-md:hidden">
                  <TableRow className="hover:bg-transparent">
                    ...
                    <TableHead className="w-[100px] font-semibold">Session ID</TableHead>
      ...
      <div className="space-y-6 w-full max-w-6xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            {canStartSession && user?.role !== "super_admin" && (
                        ...
                        <div className="grid gap-3">
                          ...
                          <Select value={assessmentTypeFilter} onValueChange={setAssessmentTypeFilter}>
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="tat">Narrative Assessment (TAT)</SelectItem>
                ...
                {pastSessions.length === 0 ? (
                  <TableRow className="max-md:block">
                    <TableCell colSpan={isSelectionMode ? 8 : 7} className="h-48 text-center max-md:block max-md:py-8">
                      ...
                      <p className="text-sm font-medium text-muted-foreground">No past sessions found</p>
                    </TableCell>
                  </TableRow>
                ) : filteredSessions.length === 0 ? (
                  <TableRow className="max-md:block">
                    ...
                    <TableRow key={idx} className="max-md:block max-md:p-4 max-md:border-b max-md:relative">
                      ...
                      <TableCell className="py-3 text-sm max-md:flex max-md:justify-between max-md:items-center max-md:p-1 max-md:border-none">
                        ...
                        <div className="flex flex-col items-start gap-1">
                          ...
                          {s.user_id && user?.id && s.user_id !== user.id && (
                            <Badge variant="outline" className="text-[10px] h-4 px-1.5 py-0 bg-blue-500/10 text-blue-500 border-blue-500/20 font-semibold tracking-wide">
                              ASSIGNED TO YOU
                            </Badge>
                          )}
                        </div>
                      ...
                      <TableCell className="py-2 text-right max-md:flex max-md:justify-between max-md:items-center max-md:p-1 max-md:border-none max-md:mt-2">
                        ...
                        <div className="flex items-center justify-end gap-1.5 flex-nowrap shrink-0">
                          ...
                          <InteractiveHoverButton
                            onClick={() => handleViewSession(s.id, s.test_type)}
                          ...
                          <Button variant="outline" size="sm" className="h-7 w-7 p-0" onClick={() => handleOpenLogs(s.id)} title="View Logs">
