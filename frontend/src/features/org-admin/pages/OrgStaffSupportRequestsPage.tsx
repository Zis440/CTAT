...
import { getClinicStaffTickets } from "@/services/supportService";
...
export function OrgStaffSupportRequestsPage() {
  ...
  const { data: tickets, isLoading, error } = useQuery({
    queryKey: ["clinic-staff-support-tickets"],
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          >
            ...
            <p className="text-text/60 text-sm">
              Review and reply to support requests submitted by your organization staff.
            </p>
          </motion.div>
          {!isSelectionMode && (
            <Button
              ...
              <div className="flex items-center gap-3">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuItem onClick={() => exportSelectedToPDF({ pdfHeader: "Staff Support Requests", columns: [{ label: "Subject", key: "subject" }, { label: "Status", key: "status" }, { label: "User Name", key: "user_name" }, { label: "Email", key: "user_email" }] })}>
                      Export as PDF
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => exportSelectedToExcel({ columns: [{ label: "Subject", key: "subject" }, { label: "Status", key: "status" }, { label: "User Name", key: "user_name" }, { label: "Email", key: "user_email" }] }, "Staff Support Requests")}>
                      Export as Excel
                    </DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
              ...
              <TableBody className="max-md:block">
                {isLoading ? (
                  <TableRow className="max-md:block">
                    <TableCell colSpan={isSelectionMode ? 6 : 5} className="py-24 text-center align-middle max-md:block max-md:py-8">
                  ...
                  <TableRow className="max-md:block">
                    <TableCell colSpan={isSelectionMode ? 6 : 5} className="py-12 text-center align-middle text-destructive max-md:block max-md:py-8">
                  ...
                  <TableRow className="max-md:block">
                    <TableCell colSpan={isSelectionMode ? 6 : 5} className="py-16 text-center align-middle max-md:block max-md:py-8">
                      <div className="flex flex-col items-center justify-center w-full space-y-3">
                        ...
                        <p className="text-sm text-text/50 max-w-xs mx-auto">
                          {searchQuery || statusFilter !== "all"
                            ...
                            : "Your organization staff haven't submitted any support requests."}
                        </p>
                      </div>
                    </TableCell>
                  </TableRow>
