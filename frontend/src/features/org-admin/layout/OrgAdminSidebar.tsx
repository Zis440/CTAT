...
import { ORG_ADMIN_NAV } from "./sidebarConfig";
...
export function OrgAdminSidebar() {
  ...
  const isActive = (to: string) => {
    ...
    if (to === "/org/dashboard") return currentPath === "/org/dashboard";
        ...
        {ORG_ADMIN_NAV.map((group, idx) => {
          ...
          return (
            <div key={idx}>
              ...
              {idx < ORG_ADMIN_NAV.length - 1 && group.label && (
