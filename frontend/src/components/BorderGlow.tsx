...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 rounded-[inherit] -z-[1] mix-blend-multiply dark:mix-blend-soft-light"
        style={{
          border: '1px solid transparent',
      ...
      <span
        className="absolute pointer-events-none z-[1] rounded-[inherit] mix-blend-normal dark:mix-blend-plus-lighter"
        style={{
          inset: `${-glowRadius}px`,
